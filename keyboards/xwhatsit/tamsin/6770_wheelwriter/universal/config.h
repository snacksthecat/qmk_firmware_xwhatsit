...
#define MANUFACTURER Tom Wong-Cornall/Purdea Andrei/kmnov2017/listofoptions/tamsin
#define PRODUCT Capacitive Wheelwriter
#define DESCRIPTION QMK firmware for the Capacitive WHEEELWRITER keyboard using a 'universal' xwhatsit controller PCB
