...
#define PRODUCT IBM Model FSSK v1.0b
#define DESCRIPTION QMK firmware for the IBM Model FSSK v1.0b keyboard using the original Xwhatsit model F controller PCB
