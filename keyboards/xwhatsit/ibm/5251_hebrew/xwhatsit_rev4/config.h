...
#define PRODUCT IBM 5251 HEBREW
#define DESCRIPTION QMK firmware for the IBM 5251 Hebrew keyboard using the original Xwhatsit beamspring rev. 4 controller PCB
